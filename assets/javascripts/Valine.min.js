...
*/
        ...
        var o = n(6), a = n(8), s = n(0), l = n(5), c = n(3), d = n(4), u = n(2), p = n(7),
            f = {comment: "", nick: "Anonymous", mail: "", link: "", ua: navigator.userAgent, url: ""}, h = {
                "zh-cn": {
                ...
                params: "",
                hide: !1
            }, g = ["nick", "mail", "link"], m = Storage && localStorage && localStorage instanceof Storage && localStorage,
            b = location.pathname.replace(/index\.html?$/, "");
        r.prototype.init = function (e) {
            if ("undefined" == typeof document) return void console;
            var t = this;
            try {
                var n = e.lang || "", r = e.langMode || "", i = v.ds, o = e.avatar, s = e.avatarForce,
                    l = e.avatar_cdn || "";
                n && r && t.installLocale(n, r), t.locale = t.locale || h[e.lang || "zh-cn"], t.notify = e.notify || !1, t.verify = e.verify || !1;
                var c = s ? "&q=" + Math.random().toString(32).substring(2) : "";
                v.params = "?d=" + (i.indexOf(o) > -1 ? o : "mp") + "&v=1.3.3" + c, v.hide = "hide" === o, v.cdn = !!l && l || v.cdn, b = e.path || b;
                ...
                var f = e.app_id || e.appId, m = e.app_key || e.appKey, x = (e.region || "cn").toLowerCase(),
                    w = ["cn", "us"];
                ...
                for (var k = d.findAll(document, ".valine-comment-count"), _ = 0, A = k.length; _ < A; _++) !function (e, n) {
                    var r = k[e];
                    if (r) {
                ...
                var O = e.el || null, S = d.findAll(document, O);
                if (!(O = O instanceof HTMLElement ? O : S[S.length - 1] || null)) return;
                t.el = O, t.el.classList.add("v"), v.hide && t.el.classList.add("hide-avatar"), e.meta = (e.guest_info || e.meta || g).filter(function (e) {
                ...
                var C = d.create("div", "class", "vloading"), M = d.find(t.el, ".vlist");
                t.loading = {
                    show: function (e) {
                        var n = d.findAll(M, ".vcard");
                        return e ? M.insertBefore(C, n[0]) : M.appendChild(C), t.nodata.hide(), t
                    }, hide: function () {
                        var e = d.find(M, ".vloading");
                        return e && d.remove(M, e), 0 === d.findAll(M, ".vcard").length && t.nodata.show(), t
                    }
                };
                ...
                t.alert = {
                    show: function (e) {
                        ...
                        if (n.innerHTML = "" + r + (e && e.type && i), d.on("click", d.find(T, ".vcancel"), function (e) {
                            t.alert.hide()
        ...
        var x = function (e, t) {
            ...
            add: function (e) {
                ...
                if (t.length) {
                    var n = t[0], r = d.attr(n, "id"), i = d.attr(n, "data-flag-title"), o = encodeURI(r),
        ...
        r.prototype.Q = function (e) {
            ...
            var n = this;
            return t = t || {}, e && (h[e] = t, n.locale = h[e] || h["zh-cn"]), n
        }, r.prototype.setPath = function (e) {
            return b = e || b, this
        }, r.prototype.bind = function (e) {
            var t = this, n = d.find(t.el, ".vemojis"), r = d.find(t.el, ".vpreview"), i = d.find(t.el, ".vemoji-btn"),
                p = d.find(t.el, ".vpreview-btn"), h = u.data;
            for (var g in h) h.hasOwnProperty(g) && function (e, r) {
                var i = d.create("i", {name: e, title: e});
                i.innerHTML = r, n.appendChild(i), d.on("click", i, function (e) {
            ...
            var x = function (e) {
                ...
                var t = e.value || "";
                if (t) {
                    s(e), t = u.parse(t), e.value = t;
                    var n = x(a(t));
                    f.comment = n, r.innerHTML = n
                } else s.destroy(e)
            };
            ...
            for (var k = e.meta, _ = {}, A = {veditor: "comment"}, O = 0, S = k.length; O < S; O++) A["v" + k[O]] = k[O];
            for (var $ in A) A.hasOwnProperty($) && function () {
                var e = A[$], n = d.find(t.el, "." + $);
                _[e] = n, n && d.on("input", n, function (t) {
            ...
            var E = function (e, t) {
                ...
                var n = d.find(t.el, ".vh[rootid='" + e + "']"), r = d.find(n, ".vquote");
            ...
            var T = function (e, n, r) {
                ...
                d.on("click", e, function (t) {
                    var n = d.attr(e, "at"), r = d.attr(e, "rid"), i = d.attr(e, "cid"), o = d.attr(e, "mail");
                    R = {
                        at: d.escape(n) + " ",
                        rid: r,
                        pid: i,
                        rmail: o
                    }, d.attr(_.comment, "placeholder", n), _.comment.focus()
                })
            };
            !function () {
            ...
            var j = function () {
                ...
                var n = w.mail(f.mail), r = w.link(f.link);
                f.mail = n.k ? n.v : "", f.link = r.k ? r.v : "", t.notify || t.verify ? F(Q) : Q()
            }, P = function () {
                var e = new AV.ACL;
                return e.setPublicReadAccess(!0), e.setPublicWriteAccess(!1), e
            }, Q = function () {
                d.attr(I, "disabled", !0), t.loading.show(!0);
                var e = AV.Object.extend("Comment"), n = new e;
                if (f.url = decodeURI(b), f.insertedAt = new Date, R.rid) {
                    var r = R.pid || R.rid;
                    n.set("rid", R.rid), n.set("pid", r), f.comment = '<a class="at" href="#' + r + '">' + R.at + "</a>" + f.comment
                }
                ...
                n.setACL(P()), n.save().then(function (e) {
                    ...
                    try {
                        ...
                        f.mail && N({
                            ...
                            mail: R.rmail
                        }), d.removeAttr(I, "disabled"), t.loading.hide(), j()
                    } catch (e) {
                        t.ErrorHandler(e)
                    }
                }).catch(function (e) {
        ...
        var a = /[&<>"'`\\]/g, s = RegExp(a.source), l = /&(?:amp|lt|gt|quot|#39|#x60|#x5c);/g, c = RegExp(l.source),
            d = {
                on: function (e, t, n, r) {
                    ...
                    if (i.indexOf(o) > -1) for (; n < r && !1 !== (t && t.call(e[n], n, e[n])); n++) ; else for (n in e) if (e.hasOwnProperty(n) && !1 === (t && t.call(e[n], n, e[n]))) break;
                    return e
                }
            };
        e.exports = d
